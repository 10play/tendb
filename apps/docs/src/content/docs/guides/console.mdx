...
<ConsoleShot dark={alertsDark} light={alertsLight} alt="The alerts screen" caption="Alerts: current findings, the schema card with auto-heal, Slack webhook setup, and the event feed." />
